namespace IntegradorRepository.LocalDatabase.Repository.Entity
{
    ...
    public partial class Ope_GradeOperacaoFretamento
    {
        ...
        [DatabaseGenerated(DatabaseGeneratedOption.Computed)]
        public DateTime? DataPartidaTolerancia { get; set; }

        [DatabaseGenerated(DatabaseGeneratedOption.Computed)]
        public DateTime? DataChegadaTolerancia { get; set; }
        ...
        public virtual Ope_GradeOperacaoOnibusFretamento Ope_GradeOperacaoOnibus { get; set; }
    }
}
